...
<div class="container-fluid">
	<div class="row mb-5">
		<div class="col-md-8 box m-auto py-3">
			<?php
			...
			<div class="post-meta d-flex justify-content-center py-4">
				<div class="post-meta__avatar-block d-flex align-items-center">
					...
					?>
					<a href="<?php echo site_url('/about') ?>"><span class="d-block text-primary custom-font-size-medium mx-2 font-weight-bold"><?php the_author(); ?></span></a>
				</div>
				
				<div class="py-3 pl-2 post-meta__date">
					<span class="custom-font-size-medium text-white bg-primary custom-background p-1 text-uppercase">last updated on: <?php echo $post_date; ?></span>
					<!--------------------COUNT VIEWS ON EVERY SINGLE POST STARTS HERE-------->
				</div>
				<div class="py-3 pl-2 post-meta__views">
					<span class="custom-font-size-medium text-primary p-1 text-uppercase font-weight-bold">
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-8 m-auto text-center">
			...
			echo '<a class="text-uppercase btn-small bg-primary custom-background rounded-pill d-inline-block text-white px-2 py-1 m-2 custom-font-size-medium" href="'.get_tag_link($tag->term_id).'"><i class="fa fa-tags pr-2 text-white"></i>'.$tag->name.'</a>';
			}
			?>
		</div>
	</div>
